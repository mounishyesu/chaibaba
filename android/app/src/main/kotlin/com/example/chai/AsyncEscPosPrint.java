...
public abstract class AsyncEscPosPrint extends AsyncTask<AsyncEscPosPrinter, Integer, Integer> {
    ...
    protected void onPreExecute() {
        if (this.dialog == null) {
            ...
            this.dialog = new ProgressDialog(context, R.style.NormalTheme);
        ...
        switch (result) {
            ...
            case AsyncEscPosPrint.FINISH_NO_PRINTER:
                new AlertDialog.Builder(context)
                        ...
                        .show();
//                new MethodChannel(MainActivity.flutterEngine.getDartExecutor().getBinaryMessenger(), MainActivity.CHANNEL).invokeMethod("error","");
